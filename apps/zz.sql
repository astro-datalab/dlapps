DROP TABLE IF EXISTS tgas_source;
CREATE TABLE IF NOT EXISTS tgas_source (
    hip	integer,
    tycho2_id	character varying,
    solution_id	bigint,
    source_id	bigint,
    random_index	bigint,
    ...
    astrometric_primary_flag	smallint,
    ...
    phot_variable_flag	character varying(255),
    l	double precision,
    b	double precision,
