/**
 *  DLAPPSP.h -- Internal declarations for the Data Lab Package applications.
 *
 *  @file       dlAppsP.h
 *  @author     Mike Fitzpatrick
 *  @date       1/03/16
 *
 *  @brief      Internal declarations for the Data Lab Package applications.
 */
...
/* Service Types.
*/
#define SVC_TAP                 0001	/* TAP service type		*/
#define SVC_CONE                0002    /* Cone search service type	*/
#define SVC_SIAP                0004	/* SIAP service type		*/
#define SVC_SSAP                0010	/* SSAP service type		*/
#define SVC_VIZIER              0020	/* Vizier TabularSkyService	*/
...
/*  Utility macros.
*/
#define DL_NEXTARG(argc,argv,i) {if(i+1>=argc||(strlen(argv[i+1])>1&&argv[i+1][0]=='-'&&(!isdigit(argv[i+1][1])))){fprintf(stderr,"Error: Option '%s' requires an argument\n",argv[i]);break;}}
